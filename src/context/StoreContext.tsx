...
const DEFAULT_PRODUCTS: Product[] = [
  // 1. ACAÍ BERRY SORBET
  {
    id: "acai-zero-sugar-500ml",
    name: "Açaí Zero Sugar Sorbet",
    price: 10.99,
    description: "Organic wild-harvested sugar-free açaí sorbet. Perfect for keto and low-sugar lifestyles.",
    image: "/acai-zero-sugar-original.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.9,
    reviewsCount: 142,
    badges: ["Zero Sugar", "Organic", "Keto Friendly"],
    specs: { calories: 90, sugar: "0g Sugar", organic: true },
    details: "Crafted with pure organic Amazonian açaí pulp. Fully sugar-free, sweetened with natural stevia and erythritol."
  },
  {
    id: "acai-original-500ml",
    name: "Açaí Original Sensation Sorbet",
    price: 10.99,
    description: "Our signature original sensation açaí sorbet. Smooth, rich, and naturally sweetened.",
    image: "/acai-passionfruit-legs.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.9,
    reviewsCount: 96,
    badges: ["Original Sensation", "Wild-Harvested", "Ready to Scoop"],
    specs: { calories: 130, sugar: "Low Sugar", organic: true },
    details: "Made with pure pulped Amazonian açaí berries and organic cane syrup. Creamy, delicious, and highly energetic."
  },
  {
    id: "acai-banana-guarana-500ml",
    name: "Açaí Banana & Guarana Sorbet",
    price: 11.99,
    description: "Classic energetic blend of wild açaí, organic bananas, and active guarana extract.",
    image: "/range-ledge.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.8,
    reviewsCount: 88,
    badges: ["Energy Boost", "Guarana Active", "Amazon Blend"],
    specs: { calories: 120, sugar: "Natural sugars", organic: true },
    details: "A classic energy-infused Brazilian recipe blending rich raw açaí pulp, organic mashed banana, and pure guarana seed extract."
  },

  // 2. SUPERFRUITS SORBET
  {
    id: "coconut-sorbet-500ml",
    name: "Creamy Coconut Sorbet",
    price: 11.99,
    description: "Creamy premium sorbet crafted from organic coconut milk and real shredded coconut flakes.",
    image: "/range-ledge.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.9,
    reviewsCount: 65,
    badges: ["100% Real Coconut", "Dairy-Free", "Vegan Creamy"],
    specs: { calories: 110, sugar: "Low sugar", organic: true },
    details: "Velvety smooth tropical sorbet prepared with rich organic coconut cream and organic coconut water. 100% plant-based."
  },
  {
    id: "mango-sorbet-500ml",
    name: "Tropical Mango Sorbet",
    price: 11.99,
    description: "Vibrant and silky sorbet made from sun-ripened organic Australian mangoes.",
    image: "/mornings-made-smoothie.jpg",
    category: "SUPER FRUITS SORBET",
    rating: 4.8,
    reviewsCount: 52,
    badges: ["Tropical Mango", "Rich Vitamin C", "Fat-Free"],
    specs: { calories: 95, sugar: "Fruity sweet", organic: true },
    details: "Juicy, smooth, and incredibly fresh, utilizing pure blended Kensington Pride mangoes for an authentic summer delight."
  },
  {
    id: "passionfruit-sorbet-500ml",
    name: "Zesty Passionfruit Sorbet",
    price: 11.99,
    description: "Tangy tropical sorbet loaded with fresh organic passionfruit pulp and seeds.",
    image: "/acai-passionfruit-legs.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.9,
    reviewsCount: 71,
    badges: ["Zesty & Tangy", "100% Natural", "Aromatic"],
    specs: { calories: 100, sugar: "Sweet & Tart", organic: true },
    details: "Rich aromatic sorbet that balance natural sweetness with the vibrant tanginess of fresh-scooped passionfruits."
  },
  {
    id: "dragonfruit-sorbet-500ml",
    name: "Red Pitaya Dragon Fruit Sorbet",
    price: 12.99,
    description: "Exotic magenta sorbet made from organic red pitaya, loaded with fiber and antioxidants.",
    image: "/range-ledge.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.7,
    reviewsCount: 43,
    badges: ["Red Pitaya", "Antioxidant Rich", "Exotic Flavor"],
    specs: { calories: 85, sugar: "Low Sugar", organic: true },
    details: "Striking pink color, made from real organic pink dragon fruit. High in prebiotic fibers and essential vitamins."
  },
  {
    id: "pineapple-sorbet-500ml",
    name: "Island Pineapple Sorbet",
    price: 11.99,
    description: "Sweet and refreshing pineapple sorbet crafted with pure pineapple juice and flesh.",
    image: "/range-ledge.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.8,
    reviewsCount: 39,
    badges: ["Island Pineapple", "Digestive Bromelain", "100% Vegan"],
    specs: { calories: 90, sugar: "Fruity sweet", organic: true },
    details: "Tastes like a sunny tropical island. Pureed ripe pineapples blended to a silky-smooth refreshing sorbet consistency."
  },
  {
    id: "acerola-strawberry-sorbet-500ml",
    name: "Acerola & Strawberry Sorbet",
    price: 12.99,
    description: "An immunity-boosting super blend of wild acerola cherries and fresh organic strawberries.",
    image: "/acai-zero-sugar-original.png",
    category: "SUPER FRUITS SORBET",
    rating: 4.9,
    reviewsCount: 57,
    badges: ["Immunity Boost", "High Vitamin C", "Fruity Blend"],
    specs: { calories: 105, sugar: "Fruity sweet", organic: true },
    details: "Acerola cherry is one of the world's richest sources of natural Vitamin C. Combined with organic strawberries, it is a healthy, tangy treat."
  },

  // 3. AÇAÍ BUCKETS (COMMERCIAL)
  {
    id: "acai-commercial-sorbet-10l",
    name: "Açaí Original Sensation Bucket 10L",
    price: 69.99,
    ...
    rating: 4.9,
    reviewsCount: 142,
    badges: ["Commercial 10L", "Organic", "Scoop-Ready"],
    specs: { calories: 120, sugar: "Low sugar", organic: true },
  ...
  },
  {
    ...
    name: "Açaí Zero Sugar Bucket 10L",
    price: 74.99,
  ...
  // 4. SMOOTHIE & PULP PACKS
  {
    id: "acai-smoothie-cubes",
    name: "Açaí Smoothie Cubes",
    price: 18.99,
  ...
  {
    id: "acai-pure-pulp-packs",
    name: "Açaí Pure Pulp Packs (Unsweetened)",
    price: 12.99,
    description: "100% pure unsweetened organic wild-harvested frozen açaí pulp packs.",
    image: "/range-ledge.png",
    category: "ACAÍ PACKS OR PACK",
    rating: 5.0,
    reviewsCount: 94,
    badges: ["Pure Pulp", "Unsweetened", "Antioxidant Rich"],
    specs: { calories: 70, sugar: "0g Sugar", organic: true },
    details: "Double-pasteurized organic deep-purple unsweetened açaí pulp blocks. Perfect as a base for custom bowls and healthy shakes."
  },
  {
    id: "acai-original-pulp-packs",
    name: "Açaí Original Blend Pulp Packs",
    price: 13.99,
    description: "Frozen original blend açaí pulp sweetened with a touch of organic cane sugar and guarana.",
    image: "/acai-passionfruit-legs.png",
    category: "ACAÍ PACKS OR PACK",
    rating: 4.8,
    reviewsCount: 61,
    badges: ["Original Blend", "Guarana Sweetened", "Ready to Blend"],
    specs: { calories: 110, sugar: "Low Sugar", organic: true },
    details: "Sweetened organic açaí berry pulp blend. Provides the classic Rio-style bowl flavor instantly when blended with banana."
  },
  {
    id: "dragon-fruit-pulp-packs",
    name: "Organic Dragon Fruit Pulp Packs",
    price: 14.99,
    description: "100% pure frozen pink dragon fruit (red pitaya) pulp packs. Super rich in fiber.",
    image: "/range-ledge.png",
    category: "ACAÍ PACKS OR PACK",
    rating: 4.8,
    reviewsCount: 37,
    badges: ["Pure Red Pitaya", "No Added Sugar", "Rich Fiber"],
    specs: { calories: 60, sugar: "0g Sugar Added", organic: true },
    details: "Organic frozen red pitaya cubes/packs. Naturally vibrant pink color, perfect for visual dragonfruit smoothie bowls."
  },
  {
    id: "coconut-water-cubes",
    name: "Coconut Water Cubes",
    price: 13.99,
    description: "Frozen coconut water cubes made from young green coconuts, perfect for direct blending.",
    image: "/mornings-made-smoothie.jpg",
    category: "OTHER FRUITS SMOOTHIE CUBES",
    rating: 4.9,
    reviewsCount: 42,
    badges: ["Pure Coconut Water", "Electrolyte Rich", "Hydration Boost"],
    specs: { calories: 45, sugar: "0g Sugar Added", organic: true },
    details: "Naturally hydrating young coconut water frozen into convenient blocks. Ideal for smoothies, ice tea, or protein shakes."
  },
  {
    id: "mixed-berry-pulp-packs",
    name: "Organic Mixed Berry Pulp Packs",
    price: 14.99,
    description: "A sweet and tart frozen blend of strawberries, blueberries, raspberries, and blackberries.",
    image: "/range-ledge.png",
    category: "ACAÍ PACKS OR PACK",
    rating: 4.9,
    reviewsCount: 29,
    badges: ["Berry Blend", "High Antioxidants", "100% Fruit"],
    specs: { calories: 80, sugar: "Low sugar", organic: true },
    details: "A curated premium blend of certified organic frozen forest berries. Flash-frozen to preserve nutrients."
  },

  // 5. ICE POPS
  {
    id: "acai-ice-pop",
    name: "Antioxidant Açaí Ice Pop",
    price: 3.99,
    description: "An icy, refreshing pop made with pure organic açaí berries and wild berry juices.",
    image: "/acai-zero-sugar-original.png",
    category: "SUPERFRUITS ICE POP LINE",
    rating: 4.8,
    reviewsCount: 88,
    badges: ["Icy Refresher", "Organic", "Dairy Free"],
    specs: { calories: 50, sugar: "Low Sugar", organic: true },
    details: "Perfect guilt-free refreshing snack on hot summer days. Hand-crafted with organic açaí puree and natural apple sweetness."
  },
  {
    id: "tropical-fruit-pop",
    name: "Tropical Fruit Ice Pop",
    price: 3.99,
    description: "A delicious blend of pineapple, mango, and passionfruit frozen into a refreshing treat.",
    image: "/acai-passionfruit-legs.png",
    category: "SUPERFRUITS ICE POP LINE",
    rating: 4.9,
    reviewsCount: 92,
    badges: ["Tropical Medley", "100% Real Fruit", "Low Calorie"],
    specs: { calories: 45, sugar: "Fruity sweet", organic: true },
    details: "Contains chunks and juices of pure organic mangoes, fresh pineapples, and zesty passionfruit seed pulp."
  }
];
