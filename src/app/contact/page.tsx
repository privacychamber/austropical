      ...
      <section className="pt-36 pb-24 max-w-container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start text-left">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-black font-display text-brand-charcoal leading-tight">
              Connect With Us.
            </h1>
            <p className="text-brand-charcoal/75 text-sm font-semibold max-w-sm leading-relaxed">
          ...
          <div className="space-y-6 pt-4 border-t border-brand-charcoal/10 text-xs font-semibold text-brand-charcoal/80">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-brand-orange/10 flex items-center justify-center text-brand-orange">
                <Mail className="w-5 h-5" />
              </div>
              <div>
                <p className="font-bold text-brand-charcoal uppercase tracking-wider text-[10px] text-brand-charcoal/40">Email Us</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-brand-charcoal uppercase tracking-wider text-[10px] text-brand-charcoal/40">Call Us</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-brand-charcoal uppercase tracking-wider text-[10px] text-brand-charcoal/40">Location</p>
        ...
        <div className="lg:col-span-7 bg-white border border-brand-charcoal/5 p-8 md:p-10 rounded-card shadow-lg">
          {success ? (
            <div className="py-12 text-center space-y-4">
              ...
              <h3 className="text-xl font-bold font-display text-brand-charcoal">Message Sent!</h3>
              <p className="text-xs text-brand-charcoal/60 font-semibold max-w-sm mx-auto leading-relaxed">
                Thank you for contacting us. A wellness advisor from our customer service team will get back to you within 24 hours.
              </p>
              <button
                onClick={() => setSuccess(false)}
                className="px-6 py-2 bg-brand-charcoal hover:bg-brand-charcoal-light text-white text-xs font-bold rounded-btn transition-colors"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-brand-charcoal/50 uppercase tracking-widest block">Your Name</label>
                  <input
                    type="text"
                    required
                    value={form.name}
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-brand-charcoal/50 uppercase tracking-widest block">Inquiry Topic</label>
                <select
                  value={form.topic}
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-brand-charcoal/50 uppercase tracking-widest block">Message</label>
                <textarea
                  required
                  rows={5}
                  value={form.message}
