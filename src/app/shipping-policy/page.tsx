      ...
      <section className="pt-36 pb-24 max-w-3xl mx-auto px-6 text-left space-y-8">
        ...
        <div className="prose prose-purple text-xs md:text-sm text-brand-charcoal/80 font-semibold space-y-6 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 className="font-extrabold text-base text-brand-charcoal">1. Delivery Coverage</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-extrabold text-base text-brand-charcoal">2. Cold-Chain Packaging</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-extrabold text-base text-brand-charcoal">3. Authority to Leave (ATL)</h3>
            <p>
