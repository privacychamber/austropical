    ...
    <div className="bg-brand-ivory text-brand-charcoal min-h-screen relative overflow-x-hidden font-sans">
      ...
      <section className="py-20 max-w-container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center text-left">
        ...
        <div className="lg:col-span-7 space-y-6">
          <h2 className="text-3xl md:text-4xl font-black font-display text-brand-charcoal leading-tight">
          ...
          <div className="border-2 border-brand-orange/20 bg-brand-orange/5 p-6 rounded-card space-y-3">
            ...
            <p className="text-brand-charcoal/85 text-xs font-semibold leading-relaxed">
      ...
      <section className="py-20 bg-white/40 border-t border-brand-charcoal/5">
        <div className="max-w-container mx-auto px-6 md:px-12 space-y-16">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            ...
            <h3 className="text-3xl md:text-5xl font-black font-display text-brand-charcoal">Supporting Local Ecosystems</h3>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="bg-[#e9f3eb] rounded-card border border-brand-green/15 overflow-hidden flex flex-col justify-between shadow-sm hover:shadow-md transition-all text-left">
              <div className="p-8 space-y-6">
                ...
                <div className="flex items-center gap-4 pb-4 border-b border-brand-green/10">
                  ...
                  <div>
                    <h4 className="text-xl font-bold font-display text-brand-charcoal leading-tight">
                ...
                <p className="text-brand-charcoal/80 text-xs font-semibold leading-relaxed">
                ...
                <div className="space-y-3">
                  <p className="text-[10px] font-black text-brand-charcoal/50 uppercase tracking-widest">Our Contribution</p>
                  <ul className="space-y-2 text-xs font-semibold text-brand-charcoal/85">
                    {[
              ...
              <div className="bg-brand-green/10 p-6 border-t border-brand-green/10 text-xs font-semibold text-brand-charcoal">
            ...
            {/* Black Jaguar Card */}
            <div className="bg-[#f0eaf5] rounded-card border border-brand-charcoal/10 overflow-hidden flex flex-col justify-between shadow-sm hover:shadow-md transition-all text-left">
              <div className="p-8 space-y-6">
                
                {/* Logo representation */}
                <div className="flex items-center gap-4 pb-4 border-b border-brand-charcoal/10">
                  <div className="w-24 h-16 bg-white rounded-lg flex items-center justify-center p-2 border border-brand-charcoal/10">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img 
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-brand-charcoal/60 uppercase tracking-wider mt-0.5">Biodiversity Corridor Partner</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-xs font-semibold text-brand-charcoal/85">
                    {[
                      ...
                      <li key={idx} className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 text-brand-charcoal/60 mt-0.5 flex-shrink-0" />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
              ...
              {/* Highlight footer block */}
              <div className="bg-brand-charcoal/10 p-6 border-t border-brand-charcoal/10 text-xs font-semibold text-brand-charcoal">
                <span className="font-extrabold text-brand-charcoal/60 block mb-1">Why It Matters</span>
      ...
      <section className="py-24 text-center max-w-2xl mx-auto px-6 space-y-8">
        <h3 className="text-3xl md:text-4xl font-black font-display text-brand-charcoal">
        ...
        <Link
          href="/shop"
          className="inline-flex items-center gap-2 px-8 py-4 bg-brand-charcoal hover:bg-brand-charcoal-light text-white font-bold text-base rounded-btn transition-colors shadow-lg hover:shadow-xl"
        >
