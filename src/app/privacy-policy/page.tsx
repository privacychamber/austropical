      ...
      <section className="pt-36 pb-24 max-w-3xl mx-auto px-6 text-left space-y-8">
        ...
        <div className="prose prose-purple text-xs md:text-sm text-brand-purple/80 font-semibold space-y-6 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 className="font-extrabold text-base text-brand-purple">1. Information We Collect</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-extrabold text-base text-brand-purple">2. How We Use Your Information</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-extrabold text-base text-brand-purple">3. Data Security</h3>
            <p>
