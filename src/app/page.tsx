      ...
      */}
      <section className="relative w-full min-h-[110vh] flex flex-col pt-0 z-10 overflow-hidden bg-black">
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="flex-1 flex flex-col lg:flex-row items-center justify-between pt-32 pb-40 px-6 md:px-12 relative z-20 w-full max-w-[1400px] mx-auto mt-12 gap-8">
          ...
          {/* Vibrant Gradient Background matching screenshot */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#FF9F1C] via-[#FF5722] to-[#E71D85] pointer-events-none -z-10" />
          ...
          <div className="flex-1 flex flex-col items-start justify-center text-left max-w-xl z-20">
            ...
            <motion.ul 
              ...
              className="mt-8 font-sans text-white text-base md:text-lg z-20 font-medium space-y-2 drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] list-none pl-0"
            >
              <li>Real tropical flavour, crafted for everyday goodness</li>
            ...
            >
              <Button className="bg-white text-[#F7931E] hover:bg-gray-100 border-none shadow-[0_10px_20px_rgba(0,0,0,0.2)] rounded-full px-10 py-4 md:py-6 text-lg md:text-xl font-black transition-all duration-300 transform hover:scale-105 uppercase tracking-widest">
                SHOP NOW
              </Button>
            </motion.div>
          </div>
          ...
          <div className="flex-1 relative w-full h-[400px] md:h-[600px] z-20 mt-16 lg:mt-0">
            ...
            <motion.div 
              ...
              className="absolute top-1/4 left-0 md:-left-10 z-30"
            >
              <TrustBadge type="circle" text="100% Vegan" color="#F7931E" rotate={-15} />
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute bottom-1/4 left-10 md:left-0 z-30"
            >
              <TrustBadge type="starburst" text="Amazon Superfood" color="#8B217D" rotate={10} />
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute top-10 right-10 md:right-0 z-30"
            >
              <TrustBadge type="circle" text="Highest Grade Açaí" color="#E71D85" rotate={15} />
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute bottom-1/3 right-0 md:-right-10 z-30"
            >
              <TrustBadge type="circle" text="Certified Organic" color="#1A5D2C" rotate={-10} />
            </motion.div>
            ...
            >
              <TrustBadge type="pill" text="Plant-Based" color="#B2D235" textColor="#1A5D2C" rotate={-5} />
            </motion.div>
          </div>
